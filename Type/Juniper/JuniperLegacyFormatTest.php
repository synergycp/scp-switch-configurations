...
class JuniperLegacyFormatTest extends TestCase {
  use TTestsFormat;

  protected function switchTypeSlug(): string {
    return JuniperLegacyType::SLUG;
  }
  ...
  public function testSetVlanWithNormalVlans() {
    ...
    $this->assertCommandEquals([
      ...
      'set interfaces ge0/0/1 unit 0 family ethernet-switching port-mode access',
  ...
  public function testSetVlanWithCombinedVlans() {
    ...
    $this->assertCommandEquals([
      ...
      'set interfaces ge0/0/2 unit 0 family ethernet-switching port-mode access',
      'set vlans vlan.123 vlan-id 123',
