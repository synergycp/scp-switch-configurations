...
class BrocadeFCXType implements Type {
  const SLUG = 'brocade-fcx';
  ...
  public function getTargetFilterer() {
    return BrocadeTargetFilterer::class;
  }
  ...
  public function getPortInterface() {
    return BrocadePortInterface::class;
  }
